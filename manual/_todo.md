...
The isolated LV probe demonstrates greater ejection at fixed starting volume and aortic pressure. In the intact LV-failure preset, reduced filling offsets that benefit. The September 6 exploration and September 23 controlled passive-VCV and fixed-effort CPAP experiments document this competition and blood redistribution without finding a sustained output increase in the selected conditions. The clinician has clarified that the purpose is mechanical understanding, not reproduction of the full clinical CPAP response: respiratory fatigue and automatic effort adaptation are outside this work. Do not adjust coefficients merely to obtain higher output or treat a missing clinical effect as proof of a numerical defect. Before extending this area, identify a specific unexplained mechanical response and the conditions needed to test it. Any external comparison must use compatible pressure references, timing and respiratory conditions. See the handover and `tools/experiments/lv-afterload.mjs`.
