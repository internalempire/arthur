...
**Try.** Observe the pleural swing, the whole-heart response and the separate RV preload-reserve readout. Compare the venous-inflow and LV-output markers, then inspect the PPV interpretability warning.
