...
|---|---|---|
| **volume** | inflation and deflation points fall approximately on the same curve | a loop may remain because equal pressure does not imply equal volume |
| **pressure** | a loop may remain because equal volume does not imply equal pressure | inflation and deflation points fall approximately on the same curve |
