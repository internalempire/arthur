...
In spontaneous mode, the PEEP control sets a continuous pressure at the airway opening throughout inspiration and expiration: zero represents unsupported breathing and a positive value represents CPAP. With muscle-pressure scale, respiratory rate and neural inspiratory time held fixed, changing CPAP changes the lung's operating volume and can also change tidal volume. The VT control does not impose volume in this mode. Muscle activity follows the prescribed activation pattern; the model does not automatically reduce effort or simulate relief of fatigue when CPAP increases. This permits a mechanical comparison at fixed effort, with filling, ejection pressure and forward output assessed separately.
